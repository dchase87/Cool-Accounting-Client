  ...
  render () {
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        <Form.Input required label='Email' placeholder='email' type='email' name='email' value={this.state.email}
        onChange={this.handleChange} />
        <Form.Input required label='Password' placeholder='password' type='password' name='password' value={this.state.password}
        onChange={this.handleChange} />
